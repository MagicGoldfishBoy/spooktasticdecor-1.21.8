...
public class RecipeGenerator extends RecipeProvider {
    ...
    public static final TagKey<Item> ENDER_WOOD_TAG = TagKey.create(
        ...
        protected void registerSoulBronzeRecipes() {
          ...
          ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.DECORATIONS, MetalRegistry.SOUL_BRONZE_SHELF_ITEM.get())
                .pattern("AAA")
                .pattern("B  ")
                .define('A', MetalRegistry.SOUL_BRONZE_SLAB_ITEM.get())
                .define('B', MetalRegistry.SOUL_BRONZE_INGOT.get())
        ...
        protected void registerSoulBrassRecipes() {
                ...
                ShapedRecipeBuilder.shaped(this.registries.lookupOrThrow(Registries.ITEM), RecipeCategory.DECORATIONS, MetalRegistry.SOUL_BRASS_SHELF_ITEM.get())
                        .pattern("AAA")
                        .pattern("B  ")
                        .define('A', MetalRegistry.SOUL_BRASS_SLAB_ITEM.get())
                        .define('B', MetalRegistry.SOUL_BRASS_INGOT.get())
